...
const categories = [
...

  {
    ...
    products: [
      { name: "Lemon", image: f5 },
      { name: "Figs", image: f6 },
      { name: "Grapes", image: f7 },
      { name: "Guava", image: f8 },
      { name: "Pear fruit", image: f15 },
      { name: "Apple", image: f10 },
      { name: "Pomegranate", image: f11 },
      { name: "Papaya", image: f12 },
      { name: "Banana", image: f13 },
      { name: "Green-apple", image: f14 },
    ],
  },

  {
    category: "Flowers",
    products: [
      { name: "Bengalor-Rose", image: fl1 },
      { name: "coconut", image: fl2 },
      { name: "white-samathi", image: fl3 },
      { name: "Orange-samanthi", image: fl4 },
      { name: "Saamanthi", image: fl5 },
      { name: "Crysanthamam", image: fl6 },
...

  {
    category: "Biscuits",
    products: [
      { name: "Milk Bikis", image: bb1 },
      { name: "Jim-Jam", image: bb2 },
      { name: "Parle-G", image: bb3 },
      { name: "Little Heart", image: bb4 },
      { name: "Marie", image: bb5 },
      { name: "Milk Bikis", image: bb6 },
      { name: "Marie-light", image: bb7 },
    ],
  },
];
